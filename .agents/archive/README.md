...
To move current loose folders (like `prompts/`, `backlog/`, etc.) into the archive:

1. Read the instructions in `UPDATE_ARCHIVE.md`.
2. Execute the steps described there (or ask an agent to "Update the archive using the instructions in .agents/archive/UPDATE_ARCHIVE.md").
