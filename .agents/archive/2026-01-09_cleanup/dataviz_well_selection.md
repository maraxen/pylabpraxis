...
- [ ] Implement visualization preview for `WellDataOutput` data (Future)
- [ ] Add chart type selection (heatmap, scatter, etc.) (Future)
- [ ] Enable export of visualization configurations (Future)
