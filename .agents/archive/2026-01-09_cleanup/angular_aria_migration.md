...
- [x] Implement `@angular/aria/grid` for microplate well selector
- [x] Support individual clicking
- [x] Support click-and-drag selection
- [x] Add "Clear Selection" and "Invert Selection" buttons
- [x] Implement selection animation rendering
...
- [x] Polish ARIA components (Select, Multiselect, Autocomplete) [NEW]
