...
1. **Review Technical Debt**:
   - [TECHNICAL_DEBT.md](.agents/TECHNICAL_DEBT.md) - Current debt items

2. **Cross-Reference Existing Tracking**:
   - [DEVELOPMENT_MATRIX.md](.agents/DEVELOPMENT_MATRIX.md) - Check for already-tracked items
   - [backlog/](.agents/backlog/) - Identify existing coverage
...
4. **Create Backlog Items**: For each new item:
   - Create backlog file using [backlog_item.md](.agents/templates/backlog_item.md) template
