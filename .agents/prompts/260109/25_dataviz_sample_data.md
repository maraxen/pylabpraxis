...
New users see empty visualizations in the Data Visualization page because there's no protocol run history. The app should ship with sample data from simulated runs.
