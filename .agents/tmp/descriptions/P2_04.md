...
---
> **Meta:** This task is defined in `/Users/mar/Projects/pylabpraxis/.agents/prompts/260110/P2_04_migrate_machine.md`.
> **Instruction:** When the task is successfully completed, please edit `/Users/mar/Projects/pylabpraxis/.agents/prompts/260110/P2_04_migrate_machine.md` to change the `**Status:**` to `Complete`.
