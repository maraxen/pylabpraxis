...
---
> **Meta:** This task is defined in `/Users/mar/Projects/pylabpraxis/.agents/prompts/260110/P2_10_migrate_data_outputs.md`.
> **Instruction:** When the task is successfully completed, please edit `/Users/mar/Projects/pylabpraxis/.agents/prompts/260110/P2_10_migrate_data_outputs.md` to change the `**Status:**` to `Complete`.
