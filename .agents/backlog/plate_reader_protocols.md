...
- [ ] **Asset Management**: Allow protocols to declare *only* a Plate Reader requirement, bypassing `layout.json` requirements if no deck interaction occurs. We should not have a layout.json requirement anyway.
