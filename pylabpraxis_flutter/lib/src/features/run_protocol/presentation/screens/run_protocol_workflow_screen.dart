    ...
    if (workflowState.preparedBackendConfig != null) {
      context.read<ProtocolStartBloc>().add(
        ProtocolStartEvent.loadConfiguration(
          preparedConfig: workflowState.preparedBackendConfig!,
        ),
      );
    } else {
      ...
      context.read<ProtocolStartBloc>().add(
        ProtocolStartEvent.reportError(
          error: "Missing prepared backend configuration.",
          preparedConfig: workflowState.preparedBackendConfig!,
        ),
      );
    }
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          onPressed: () {
            ...
            if (currentStartState is! ProtocolStartingExecution &&
                currentStartState is! ProtocolStartSuccess) {
      ...
      body: BlocConsumer<ProtocolStartBloc, ProtocolStartState>(
              ...
              SnackBar(
                content: Text(
                  state.response.message ??
                      'Protocol run successfully initiated! Run ID: ${state.response.runId}',
                ),
        ...
        builder: (context, state) {
          return switch (state) {
            ...
            ProtocolStartReady(preparedConfig: final preparedConfig) => Center(
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      preparedConfig['name'] ?? 'Selected Protocol',
                    ...
                    ElevatedButton.icon(
                      ...
                      onPressed: () {
                        ...
                        if (wfState.preparedBackendConfig != null) {
                          context.read<ProtocolStartBloc>().add(
                            ProtocolStartEvent.executeStartProtocol(),
                          );
                        }
                      },
                    ),
            ...
            ProtocolStartingExecution() => const Center(
              child: Column(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 24),
                    Text(
                      state.response.message ?? 'Protocol Run Initiated!',
                      style: theme.textTheme.headlineMedium,
                      textAlign: TextAlign.center,
                    ),
                    ...[
            ...
            ProtocolStartFailure(
              error: final error,
              preparedConfig: final preparedConfig,
            ) =>
              Center(
                child: Padding(
