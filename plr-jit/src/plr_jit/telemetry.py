"""plr_jit.telemetry: emission surface for analyzer events (spec 260901 §4).
...
scale for a *dynamic* harness. plr-jit is a *static* analyzer, so four of
...
handed; callers are expected to pass ``plr_jit._provenance.survey_stamp()``,
...
from plr_jit.verdict import REASON_VOCABULARY, Finding, PlrSite, Verdict
