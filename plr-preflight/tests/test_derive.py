"""Spec 260901 §7.5 / T6 (backlog #4829): the seven `plr_preflight.derive` tests
named in §7.5.
...
`plr_preflight.check._supported_tools` (T8, spec §6.2's D1 note); `plr_preflight.derive`
...
from plr_preflight.derive.__main__ import build_derived_contracts_payload
