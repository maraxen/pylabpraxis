...
(``plr-preflight/data/derived_contracts.upstream_nonlegacy.json``, produced by
...
CONTRACTS_JSON = PLR_PREFLIGHT_ROOT / "data" / "derived_contracts.upstream_nonlegacy.json"
