...
from plr_preflight.derive import InlinedGuard, SurveyRecord, build_index
from plr_preflight.differential import (
    Disagreement,
    HandContract,
    build_report,
    classify_contract,
...
def survey_records() -> list[SurveyRecord]:
    from plr_preflight.derive import load_survey
