"""plr_preflight._provenance: provenance capture (spec 260901 §2).
...
from plr_preflight._provenance.stamp import DEFAULT_SURFACE, Surface, SurveyStamp, survey_stamp
