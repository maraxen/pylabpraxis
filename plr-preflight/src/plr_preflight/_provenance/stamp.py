"""plr_preflight._provenance.stamp: process-memoized SurveyStamp (spec 260901 §2.2;
...
# plr-preflight/src/plr_preflight/_provenance/stamp.py -> repo root is four parents up.
