"""AC / HM cross-reference lint for the plr-preflight spec (round-6 recommendation).
...
Usage::
    ...
    uv run python plr-preflight/scripts/check_spec_crossrefs.py \
        --spec .praxia/docs/specs/260901_plr-preflight-pre-corpus-spec.md \
        --registry plr-preflight/src/plr_preflight/_hand_maintained.py
