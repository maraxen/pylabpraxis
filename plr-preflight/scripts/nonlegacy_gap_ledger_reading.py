...
``plr-preflight/data/derived_contracts.upstream_nonlegacy.json``,
``plr-preflight/data/gap_ledger.upstream_nonlegacy.json``) and computes the
...
Usage::
    ...
    uv run python plr-preflight/scripts/nonlegacy_gap_ledger_reading.py
    uv run python plr-preflight/scripts/nonlegacy_gap_ledger_reading.py --json
"""
...
sys.path.insert(0, str(REPO_ROOT / "plr-preflight" / "src"))

from plr_preflight.derive import (  # noqa: E402
    SurveyRecord,
    build_contract_keys,
    build_index,
    derive_contract,
...
CONTRACTS_JSON = REPO_ROOT / "plr-preflight" / "data" / "derived_contracts.upstream_nonlegacy.json"
GAP_LEDGER_JSON = REPO_ROOT / "plr-preflight" / "data" / "gap_ledger.upstream_nonlegacy.json"
