...
## Daily
- [260903_overnight-decisions](daily/260903_overnight-decisions.md) — Decision log for the autonomous praxia dev loop run at elevated autonomy after the user invoked /loop with the loop skill: every autonomous choice (worktree base, item selection, fallbacks, skipped gates) with enough context to backtrack.
