---
title: 'plr-jit T14: upstream_nonlegacy gap-ledger reading'
...
sources: ''
---
# plr-jit T14: upstream_nonlegacy gap-ledger reading

Reads `plr-jit/data/gap_ledger.upstream_nonlegacy.json` and
`plr-jit/data/derived_contracts.upstream_nonlegacy.json` (T13,
`upstream_nonlegacy` surface, pin `3a50a567f`) and the family/depth
cross-tabulations computed by
`plr-jit/scripts/nonlegacy_gap_ledger_reading.py`. Companion to T6's legacy
...
`_unfiltered`** (`plr_jit.derive._dropped_receiver_worklist_whole_surface`,
...
- `plr-jit/data/gap_ledger.upstream_nonlegacy.json`,
  `plr-jit/data/derived_contracts.upstream_nonlegacy.json` -- regenerated
...
- `plr-jit/scripts/nonlegacy_gap_ledger_reading.py` -- the family-breakdown,
  ...
  extend).
- `plr-jit/tests/test_check_graph_nonlegacy.py`,
  `plr-jit/tests/test_derive.py` (T14 additions) -- the permanent
