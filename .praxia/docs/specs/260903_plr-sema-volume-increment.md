...
`condition` string (`plr-sema/data/derived_contracts.json:86499`) and is evaluated as part of the
...
seeds itself — `_precondition_plan` returns a `seed_volumes` dict (`plr-sema/eval/oracle_common.py:871-877`;
