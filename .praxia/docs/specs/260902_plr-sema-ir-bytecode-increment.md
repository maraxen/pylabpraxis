...
| a per-method PLR parameter list | `SurveyRecord.params` (`derive/__init__.py:177`), already surveyed by `_function_params` (`survey_plr_preconditions.py:303-310`), shipped as an additive `params` key (§11.2.4) |
