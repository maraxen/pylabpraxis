...
test('Capture application UI screenshots', async ({ page }) => {
    ...
    // If the dialog asks to choose between Machine and Resource
    ...
    // Wait for the button to be enabled - it might be "Next" or have a different label
    ...
    if (await nextButton.isVisible()) {
        ...
        // Fallback to clicking by role if locator fails
