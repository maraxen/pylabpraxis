/**
 * Mock protocol runs for demo mode
 */
export const MOCK_PROTOCOL_RUNS = [
    {
        ...
        protocol_name: 'Simple Liquid Transfer',
        status: 'COMPLETED',
    ...
    },
    {
        ...
        current_step: 'Performing dilution 5 of 8',
    ...
    },
    {
        ...
        protocol_name: 'Plate Preparation',
        status: 'QUEUED',
        input_parameters_json: {
            assay_plate: 'plate-004',
            wash_buffer: 'reservoir-001',
            reagent: 'reservoir-002',
            wash_cycles: 3
        },
