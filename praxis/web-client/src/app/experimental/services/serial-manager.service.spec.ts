...
import { MockSerial, MockSerialDriver } from '../drivers/mock-serial';
import { registerDriver, resetRegistry, enableTestMode, findDriverByName, unregisterDriver } from '../drivers/driver-registry';
