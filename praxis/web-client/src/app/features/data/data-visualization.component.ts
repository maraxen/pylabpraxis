      ...
      <mat-card class="selector-card">
        <mat-card-content>
          <div class="selector-row">
            <mat-form-field appearance="outline" class="protocol-select">
            ...
            <mat-form-field appearance="outline" class="run-select">
              <mat-label>Run</mat-label>
              <mat-select [(ngModel)]="selectedRunId" (ngModelChange)="onRunChange($event)">
                @for (run of filteredRuns(); track run.id) {
                  <mat-option [value]="run.id">
                    <span class="run-option">
                      ...
                      {{ run.protocolName }} - {{ run.startTime | date:'short' }}
                    </span>
                  </mat-option>
                }
              </mat-select>
