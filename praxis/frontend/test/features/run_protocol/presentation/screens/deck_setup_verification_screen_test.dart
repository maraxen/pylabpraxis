...
import 'package:pylabpraxis_flutter/src/features/run_protocol/presentation/screens/deck_setup_verification_screen.dart';
...
void main() {
  ...
  late MockWorkcellApiService mockWorkcellApiService; // Needed by VisualizerBloc
  ...
  setUp(() {
    ...
    mockWorkcellApiService = MockWorkcellApiService(); // VisualizerScreen will create its own bloc, but needs this if we were to mock the bloc provider's create function
  ...
  testWidgets(
    ...
    await tester.pumpWidget(
        createTestableWidget(const DeckSetupVerificationScreen(workcellId: testWorkcellId)));
