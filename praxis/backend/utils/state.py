...
class State: # This will be aliased as PraxisState
    def __init__(self, run_guid: str, redis_host: str = "localhost", redis_port: int = 6379, redis_db: int = 0):
    ...
    def _load_from_redis(self) -> Dict[str, Any]:
        try:
            ...
            logger.error(f"JSONDecodeError while loading state for run {self.run_guid} from Redis: {e}. Raw data: {serialized_state!r}")
            return {} 
