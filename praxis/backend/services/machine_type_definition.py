...
from praxis.backend.models.pydantic.machine import MachineTypeDefinitionCreate, MachineTypeDefinitionUpdate
...
class MachineTypeDefinitionService(
    DiscoverableTypeServiceBase[MachineDefinitionOrm, MachineTypeDefinitionCreate, MachineTypeDefinitionUpdate]
):
