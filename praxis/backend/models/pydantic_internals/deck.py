...
# Rebuild models to resolve forward references from ResourceCommon and ResourceResponse
DeckBase.model_rebuild()
DeckCreate.model_rebuild()
DeckUpdate.model_rebuild()
