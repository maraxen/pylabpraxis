...
class ResourceDefinitionOrm(PLRTypeDefinitionOrm):
  ...
  # Dynamic filtering fields - extracted from PLR objects during sync
  num_items: Mapped[int | None] = mapped_column(
    nullable=True,
    default=None,
    index=True,
    comment="Number of items (wells for plates, tips for tip racks).",
  )
  plate_type: Mapped[str | None] = mapped_column(
    String,
    nullable=True,
    default=None,
    index=True,
  ...
  well_volume_ul: Mapped[float | None] = mapped_column(
    Float,
    nullable=True,
    default=None,
    index=True,
  ...
  tip_volume_ul: Mapped[float | None] = mapped_column(
    Float,
    nullable=True,
    default=None,
    index=True,
