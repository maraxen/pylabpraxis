...
class SearchFilters(BaseModel):
  ...
  offset: int = Field(0, ge=0, description="Number of results to skip before returning.")
  date_range_start: datetime | None = Field(None, description="Filter records created/updated after this timestamp.")
  date_range_end: datetime | None = Field(None, description="Filter records created/updated before this timestamp.")
