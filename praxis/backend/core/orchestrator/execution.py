...
class ExecutionMixin:
  ...
  async def execute_protocol(
    ...
    Args:
        ...
        input_parameters: User-provided input parameters.
    ...
    logger.info(
      "ORCH: Initiating protocol run %s for '%s' at %s (simulation=%s). User params: %s",
      run_accession_id,
      protocol_name,
      start_iso_timestamp,
      is_simulation,
  ...
  async def execute_existing_protocol_run(
    ...
    logger.info(
      "ORCH: Executing existing protocol run %s for '%s' (simulation=%s).",
      run_accession_id,
      protocol_name,
      is_simulation,
    )
