...
class Container(containers.DeclarativeContainer):
  ...
  resource_type_definition_service: providers.Singleton[ResourceTypeDefinitionService] = (
    providers.Singleton(
      ResourceTypeDefinitionService,
      db=db_session,
    )
  ...
  protocol_run_service: providers.Singleton[ProtocolRunService] = providers.Singleton(
    ProtocolRunService,
  )
  protocol_definition_service: providers.Singleton[ProtocolDefinitionCRUDService] = (
    providers.Singleton(ProtocolDefinitionCRUDService)
  )
