...
class PraxisConfiguration:
  ...
  def default_protocol_dir(self) -> str:
    ...
    """
    # Navigate up from praxis/backend to praxis, then into protocol/protocols
    praxis_root = os.path.dirname(os.path.dirname(__file__))  # praxis/
    default_path = os.path.join(praxis_root, "protocol", "protocols")
