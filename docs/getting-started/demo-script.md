...
This script provides a step-by-step walkthrough of the Praxis platform in **Demo Mode**. It highlights key features including asset management, protocol execution, and live monitoring.

## Prerequisites

Ensure you have the application running in Demo Mode:
...
3. **Active Runs**: In Demo Mode, you might see 0 active runs initially.
